...
The Coffee Sales Analysis Dashboard is an interactive Microsoft Excel
project designed to analyze coffee sales performance across customers,
...
analysis, and dashboard design using Excel.
...
**coffeeOrdersProject.xlsx** → Contains the full data model, analysis,
and dashboard.
